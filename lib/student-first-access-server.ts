...
export async function provisionStudentFirstAccess(
  ...
  if (student.user_id) return { created: false, reason: "already_linked" as const };
  ...
  if (reservation.error?.code === "23505") return { created: false, reason: "already_reserved" as const };
