export type StudentExamLaw = { id: number; slug: string; titulo: string; ordem: number; emEstudo: boolean; revisao: boolean; campaignStatus: "nao_iniciada" | "em_andamento" | "concluida" };
