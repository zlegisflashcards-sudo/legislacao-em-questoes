...
export function AdminQuestionEditor({ lawName, nodes, value, original, editing, saving, error, onChange, onSubmit, onCancel }: { lawName: string; nodes: AdminQuestionStructureNode[]; value: AdminQuestionForm; original: AdminQuestionForm | null; editing: boolean; saving: boolean; error?: string; onChange: (value: AdminQuestionForm) => void; onSubmit: (event: React.FormEvent<HTMLFormElement>) => void; onCancel?: () => void }) {
