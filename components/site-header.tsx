...
import { headerNavigation, legisQuestionsNavigation, type SiteNavigationItem } from "@/lib/site-navigation";
...
export function SiteHeader() {
  ...
  const legisQuestions = legisQuestionsNavigation(authenticated);
