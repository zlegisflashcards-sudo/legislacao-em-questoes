...
type Campaign = { status: "nao_iniciada" | "em_andamento" | "concluida"; progress: number; bestScore?: number | null; record?: { score: number; errors: number; totalQuestions: number } | null; result?: { position?: number | null }; levels?: CampaignLevel[] };
