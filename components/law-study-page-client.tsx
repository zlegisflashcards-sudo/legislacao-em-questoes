...
type Campaign = { status: "nao_iniciada" | "em_andamento" | "concluida"; progress: number; bestScore?: number | null; result?: { position?: number | null }; levels?: CampaignLevel[] };
